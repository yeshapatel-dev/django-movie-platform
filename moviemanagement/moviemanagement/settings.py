"""
Django settings for moviemanagement project.
...
SECRET_KEY = 'django-insecure-zp0y5%em=wj2&#r0t(4f11az-je200r1)%--rgyg%xhjc*-koz'
...
WSGI_APPLICATION = 'moviemanagement.wsgi.application'
